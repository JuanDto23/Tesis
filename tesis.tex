...
%-------------------------------------------------------------------------------
\title{Simulación paralela del Juego de la Vida en un clúster de computadoras}
...
\input{1-Introduction/1-Planteamiento}
	\input{1-Introduction/2-Antecedentes}
	\input{1-Introduction/3-Objetivos}
	\input{1-Introduction/3-1-ObjGenerales}
	\input{1-Introduction/3-2-ObjEspecificos}
	\input{1-Introduction/4-Metodologia}
	\input{1-Introduction/5-Justificacion}
	\input{1-Introduction/6-AlcanceLimitaciones}
	\input{1-Introduction/7-Descripcion}
% \input{2-Theory/1-Basics}
% 	\input{2-Theory/2-Something_more_specific}
% \input{3-Results/1-Something}
% \input{4-Conclusions/1-Conclusions}
...
% \appendix
% \input{6-Apendices/1-Something_extra.tex} 
